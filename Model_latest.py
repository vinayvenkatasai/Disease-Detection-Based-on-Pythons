...
df_comb = pd.read_csv("D:\Knock\Disease-Detection-based-on-Symptoms\Disease-Detection-based-on-Symptoms-master\Dataset\dis_sym_dataset_comb.csv")
...
MNB works better on discrete features and the multinomial distribution usually requires integer counts.
"""
